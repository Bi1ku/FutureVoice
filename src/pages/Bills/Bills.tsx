              ...
              <div className="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0">
                <div className="-mt-px flex w-0 flex-1">
                  <button
                    ...
                    className={`inline-flex items-center pr-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700 ${page - 1 < 0 && "cursor-not-allowed"}`}
                    disabled={page - 1 < 0}
                  >
                    <ArrowLongLeftIcon
                      aria-hidden="true"
                ...
                <div className="hidden md:-mt-px md:flex">
                  <button
                    onClick={() => setPage(1)}
                    className={`inline-flex items-center ${page === 1 ? "text-[#457B9D]" : "text-gray-500"} px-4 pt-4 text-sm font-medium hover:border-gray-300 hover:text-gray-700`}
                  >
                    1
                  </button>
                  <button
                    onClick={() => setPage(2)}
                    className={`inline-flex items-center   ${page === 2 ? "text-[#457B9D]" : "text-gray-500"} px-4 pt-4 text-sm font-medium hover:border-gray-300 hover:text-gray-700`}
                  >
                    2
                  </button>
                  <button
                    onClick={() => setPage(3)}
                    className={`inline-flex items-center   ${page === 3 ? "text-[#457B9D]" : "text-gray-500"} px-4 pt-4 text-sm font-medium hover:border-gray-300 hover:text-gray-700`}
                  >
                    3
                  </button>{" "}
