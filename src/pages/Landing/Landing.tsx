        ...
        <section id="features" className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center bg-[#E63946] text-white p-6 shadow-lg rounded-md">
              ...
              <div className="text-center bg-[#457B9D] text-white p-6 shadow-lg rounded-md">
                <h3 className="text-2xl font-semibold mb-4">
              ...
              <div className="text-center bg-[#A8DADC] text-white p-6 shadow-lg rounded-md">
                <h3 className="text-2xl font-semibold mb-4">
